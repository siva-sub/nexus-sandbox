...
def parse_pacs008(xml_content: str) -> dict:
    ...
    try:
        ...
        return {
            ...
            "settlementCurrency": get_text(".//IntrBkSttlmAmt/@Ccy") or get_text(".//doc:IntrBkSttlmAmt/@Ccy"),
            ...
            "instructedCurrency": get_text(".//InstdAmt/@Ccy") or get_text(".//doc:InstdAmt/@Ccy"),
